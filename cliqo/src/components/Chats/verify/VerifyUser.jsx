        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose how you'd like to verify your identity on Cliqo. Verified accounts get more trust and better connections!
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Take a selfie to verify your identity. This helps keep the Cliqo community safe and authentic.
                </p>
