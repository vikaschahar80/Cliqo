    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
        ...
        <div className="fixed top-0 left-0 right-0 p-4 flex justify-between items-center border-b border-slate-200 bg-white/80 backdrop-blur-md">
          <div className="flex items-center gap-2">
            <img src={logo2} alt="Cliqo" className="h-8 w-8" />
            <span className="font-bold text-slate-900">Cliqo</span>
          </div>
          {renderHeaderIcons()}
        </div>
    ...
    <div className="min-h-screen bg-slate-50 pb-20 overflow-x-hidden">
      <header className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-200/50">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={logo2} alt="Cliqo" className="h-8 w-8 rounded-lg" />
            <span className="font-bold text-xl tracking-tight text-slate-900">Cliqo</span>
          </div>
          {renderHeaderIcons()}
        </div>
      </header>
