            ...
            <CardContent className="p-6 sm:p-10">
              ...
              <TabsContent value="identity" className="space-y-6 mt-0">
                ...
                <div className="space-y-4 p-5 rounded-2xl bg-slate-50 border border-slate-100">
                  ...
                  <p className="text-slate-400 text-xs mb-2">Select which verification credentials you wish to apply to your Cliqo account. You can select any combination!</p>
