        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-200 shadow-xl prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-8">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-sm md:text-base">
            <p className="m-0 font-medium text-slate-700">
              Welcome to <strong>Cliqo</strong>! These Terms and Conditions govern your access to and use of our website, mobile application, database integrations, and matching services. By registering an account, completing your verification, or utilizing our real-time messaging, you agree to be fully bound by these Terms.
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            <section id="accounts" className="scroll-mt-6">
              ...
              <p>To use most features of Cliqo, you must register a unique account. You agree to:</p>
              <ul className="list-disc list-inside pl-4 space-y-1">
            ...
            <section id="verification" className="scroll-mt-6">
              ...
              <p>Cliqo prioritizes authentic connections through its verification protocols:</p>
              <ul className="list-disc list-inside pl-4 space-y-1">
                ...
                <li><strong>Photo ID & Selfie Verification</strong>: By uploading a selfie and an ID card, you grant Cliqo's administrative team permissions to compare these details manually.</li>
                <li><strong>Disclaimer</strong>: Verification statuses (Verified Badge) verify that identity or institution affiliation has been confirmed against submitted materials. Cliqo does not perform criminal background checks or character screens. You agree to always prioritize your personal safety when meeting people in the real world.</li>
              </ul>
            </section>
            ...
            <section id="conduct" className="scroll-mt-6">
              ...
              <p>You are solely responsible for all content, chats, and actions on Cliqo. You agree NOT to:</p>
              <ul className="list-disc list-inside pl-4 space-y-1">
            ...
            <section id="maps" className="scroll-mt-6">
              ...
              <p>Cliqo features interactive location tools to show active members near you:</p>
              <ul className="list-disc list-inside pl-4 space-y-1">
                ...
                <li>Cliqo does not continuously track your device's location in the background when the application is closed.</li>
              </ul>
            </section>
            ...
            <section id="ip" className="scroll-mt-6">
              ...
              <ul className="list-disc list-inside pl-4 space-y-1">
                <li>By uploading photos, prompts, or text, you grant Cliqo a non-exclusive, royalty-free, worldwide license to host, display, and distribute this material purely to operate the service.</li>
                <li>Cliqo retains full ownership of its trademarks, logos, custom graphics, and codebase. You agree not to copy, reverse-engineer, or scrape any part of Cliqo.</li>
              </ul>
            </section>
            ...
            <section id="disclaimers" className="scroll-mt-6">
              ...
              <p>The Cliqo service is provided entirely <strong>"as is"</strong> and <strong>"as available"</strong> without warranties of any kind, whether express or implied. We do not guarantee that the service will be uninterrupted, error-free, completely secure, or that any matches will be compatible.</p>
            </section>
